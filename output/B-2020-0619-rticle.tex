...
\hypertarget{packages-need-to-update-rjreferences-already-updated.}{%
\subsection{Packages \textless= need to update, RJreferences already
updated.}\label{packages-need-to-update-rjreferences-already-updated.}}
...
\textbf{Discussions} (NOTE TO MENTORS: based on latest 2019 Run 04 or
...
terms of speed. The best in this class were \CRANpkg{minpack.lm} and
