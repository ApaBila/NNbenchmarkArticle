...
\title{A review of R neural network packages with NNbenchmark\(:\) ease of use
...
\abstract{%
Possible format: 1) the overall purpose of the study and the research
problem(s) you investigated; 2) the basic design of the study; 3) major
findings or trends found as a result of your analysis; and, 4) a brief
