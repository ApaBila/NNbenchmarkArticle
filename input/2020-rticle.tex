...
normalization, and it is especially recommended for \CRANpkg{validann} .
However, some of the packages depending on \CRANpkg{nnet} do have this
utility and it is included in the scoring for ease of use. With
\CRANpkg{NNbenchmark}, this is done through setting scale = TRUE in the
