...
<!-- B: I believe these were the packages for neural networks at the time using nnet but not for regression. Suggestion: Moreover, 8 of the neural network packages outside the scope of this research were found to use nnet. 
