...
adaptive step. 
<!-- Ref 3 - comment 7 -->
\textcolor{orange}{This yields to the so-called first-order methods 
using both the function to be optimized and its gradient.}
...
<!-- Ref 3 - comment 7 -->
\textcolor{orange}{This yields to the so-called second-order methods 
...
The full list of the maximum iteration number per \code{package:algorithm} is given in Table \ref{tab:allscore} in Appendix D. 
...
Table \ref{tab:TOP10:bWoodN1} gives the metric performance over 20 runs of these TOP-5 five packages on \code{bWoodN1}.
...
We also thank the three anonymous referees for their relevant advices and comments.
