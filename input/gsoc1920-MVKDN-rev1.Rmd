...
as an appropriate learning rate differed between packages, despite the algorithm 
...
first-order algorithms where different \code{maxit} values was used.}
...
if(file.exists("./tables/Table1-rev-Callrating.csv")) {  
  Table1 <- read.table("./tables/Table1-rev-Callrating.csv", sep = ";", dec=".",
                       header=TRUE)
...
kableExtra::kable(TableEaseOfUse, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="lcccccl",
                  caption="Ease of use of Tested Packages") %>%
...
and modifies the relative offset convergence criterion to avoid a zero divide 
