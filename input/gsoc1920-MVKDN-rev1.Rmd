...
This is an issue as many slow or poor algorithms are available in the literature and hence 
<!-- Ref 2 - Comment 14 -->
\textcolor{blue}{bad} packages are implemented on CRAN.
...
In conducting this study, we hypothesize that these second-order algorithms would perform better 
than the first-order methods for datasets that fit in memory. 
...
the \code{NNsummary} function computing convergence metrics and speed.}
...
An example of a 
<!-- Ref 3 - Comment 5 -->
\textcolor{orange}{benchmark} to \code{trainPredict\_1pkg} is given in Appendix C,
<!-- Ref 3 - Comment 5 -->
