...
As with other optimization problems, the gradient of the chosen cost function that indicates the model's lack of suitability is sought. <!-- B??: not sure, should it be "the chosen cost function which" or if the sentence should be split into one for the gradient and one for the cost function. Remove double the. CD yest it could be improved -->
