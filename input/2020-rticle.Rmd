...
SB : REMOVED as should be from Patrice's email
-->
...
The full list of the maximum iteration number per package:algorithm is given in Appendix C. It can be seen that we were unable to completely harmonize the hyperparameters as an appropriate learning rate differed between package, despite the algorithm being similarly named.
...
The resulting files in the repository were mostly generated by one of us (SM) on a Windows system build 
