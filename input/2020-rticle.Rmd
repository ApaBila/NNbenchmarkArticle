...
Speed and variation between results are also not as good as other packages that use \code{optim}. 
...
<!-- B??: not sure of a good flow yet for the first order algorithms, for the 2ndorder ones it was quite easy to point out the red string that ties them together. Any suggestions? Going by order of number of algorithms ...? would be rather odd -->
