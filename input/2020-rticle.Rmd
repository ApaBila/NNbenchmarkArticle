...
<!-- JN??: "output output" replaced by "output" -->
...
<!-- JN: changed quotes as they were not equivalent in appearance; "falls" becomes "fall" -->
...
<!-- JN: drop possessive for CRAN; "a dependency" rather than "the dependency" -->
...
<!-- JN: "the template" rather than "template" -->
...
<!-- JN: "incredible" becomes "very helpful"; "were added" moved forward in sentence -->
...
<!-- JN: "considered datasets" becomes "datasets under consideration" -->
...
<!-- JN: put CRANpkg around validann -->
...
Our research found that 6 of the 11 packages tested that use optim do so through \CRANpkg{nnet}. 
...
<!-- JN: Maybe worth putting in. However, we are already saying lots! I think the mention below is enough. Note I changed -->
<!-- "call" to "calls" -->
...
<!-- JN: changed wording to read more clearly -->
...
<!-- JN: "easy to use" becomes "easy-to-use" -->
...
JN: "criterium" becomes "criterion"
...
<!-- JN: minor typo corrections below -->
...
<!-- JN: minor grammar corrections below -->
...
The novelty of this package is apparently in the "deeptree" and "deepforest" functions it provides. 
