...
For instance, \CRANpkg{MachineShop}, \CRANpkg{nnet}, \CRANpkg{nlsr} do not correctly capture the sinusoidal 
aspect of explanatory variable $x_5$ on the expected response, whereas \CRANpkg{rminer}, \CRANpkg{validann}
...
1) B?? I'm not sure about this since the results for the big datasets start of with validann rminer behind on minimum RMSE?? CD: MachineShop has very good time median and very close RMSE min; rminer is slower but has better MAE median and WAE median, see Table 4
