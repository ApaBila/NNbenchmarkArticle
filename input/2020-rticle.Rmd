...
By contrast, \pkg{validann} is clearly a package that allows a user to use all optim's algorithms. <!-- B: John, moved this down to "first order algorithms" section. Correct or? See more there (We caution users to avoid method SANN.) --> \pkg{validann}\code{:L-BFGS-B} ranks mostly lower than \pkg{validann}\code{:BFGS}, despite the former
