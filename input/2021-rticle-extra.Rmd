...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  ...
                  caption="Result for \\code{mDette}") %>%
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{mFriedman}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{mIshigami}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{mRef153}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uDmod1}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uDmod2}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uDreyfus1}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uDreyfus2}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uGauss1}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uGauss2}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uGauss3}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="llcccccc",
                  caption="Result for \\code{uNeuroOne}") %>%
  column_spec(c(1, 2), bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8) %>%
  footnote(general="Statistics over 10 runs; time in seconds.", footnote_as_chunk=TRUE)
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{img/scoreprobperpkgBlues.png}
        \label{fig:scoreprob}
...
## Summary statistics for top-10 packages
...
```{r, echo=FALSE}
resPerDataSet <- read.csv("tables-extra/bWoodN1-results-summary-top10.csv")


resPerDataSet <- resPerDataSet[order(resPerDataSet[, "RMSE.min"]), 1:7]
colnames(resPerDataSet) <- c("Package","Time mean","RMSE min",   
    "RMSE median", "RMSE D51",    "MAE median" ,
    "WAE median")

kableExtra::kable(resPerDataSet, format = "latex", booktabs = TRUE, 
                  centering = TRUE, align="lcccccc", row.names=FALSE,
                  caption="Result for \\code{bWoodN1}") %>%
  column_spec(1, bold = TRUE) %>%
  collapse_rows(columns = 1, latex_hline = "major", valign ="middle") %>%
  kable_styling(font_size=8, latex_options =c("hold_position")) %>%
  footnote(general="Statistics over 20 runs; time in seconds.", footnote_as_chunk=TRUE)
```
